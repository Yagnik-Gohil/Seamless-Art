                    ...
                    <div className='d-flex align-items-start flex-wrap'>
                        <div className='p-3 mw-fc shadow m-2'>
                            <div className='d-flex justify-content-center mb-3'>
                                <img className='account-image' src={isFileChange ? URL.createObjectURL(file) : path + file} alt="User Image"></img>
                            </div>
                            ...
                            <form className='p-4 pt-0'>
                                <div className="row my-3">
                                    ...
                                    <div className="col-md-8 col-sm-12">
                                        <input type="text" name="name" className="form-control" value={details.name} onChange={handleInput}/>
                                    </div>
                                </div>
                                <div className="row my-3">
                                    <div className="col-md-4 col-sm-12">
                                    ...
                                    <div className="col-md-8 col-sm-12">
                                        <input type="text" name="email" className="form-control" disabled  value={details.email}/>
                                    </div>
                                </div>
                                ...
                                <div className="row my-3">
                                    ...
                                    <div className="col-md-2 col-sm-12">
                                        <img src={isFileChange ? URL.createObjectURL(file) : path + file} className="img-thumbnail w-100" alt="..."></img>
                                    </div>
                                ...
                                <div className="row my-3">
                                    ...
                                    <div className="col-md-8 col-sm-12">
                                        <div>
                                            <input type="text" name="address_1" className="form-control" placeholder='Street' value={details.address_1} onChange={handleInput}/>
                                        </div>
                                        <div className='mt-3'>
                                            <input type="text" name="address_2" className="form-control" placeholder="City - PIN" value={details.address_2} onChange={handleInput}/>
                                        </div>
                                        <div className='mt-3'>
                                            <input type="text" name="address_3" className="form-control" placeholder="State, Country" value={details.address_3} onChange={handleInput}/>
                                        </div>
                                    </div>
                                </div>
                                <div className="d-flex flex-column">
                                    <div className='align-self-end'>
                                        <button type="button" className="btn text-white m-1 bg-blue card-btn fs-12" data-bs-dismiss="modal" onClick={submitData}>Save</button>
                                    </div>
                                </div>
