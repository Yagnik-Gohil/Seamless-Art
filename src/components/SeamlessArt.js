    ...
    <Fragment>
      <div className='p-3 d-flex justify-content-center align-items-center text-center vh-80'>
        <div>
          ...
          <p className='fw-bold m-1'>Source Code: <a className='text-dark text-decoraation-none' href='https://github.com/Yagnik-Gohil/Seamless-Art' target="_blank"><AiFillGithub size={30}/></a></p>
          {
            !userEmail &&
            <p className='fw-bold'>
